    ...
    <div style={{ width: "100%", minHeight: "calc(100vh - 52px)", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 24, boxSizing: "border-box" }}>
      ...
      <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 14, overflow: "hidden" }}>
        <div style={{ padding: "24px 20px 20px", textAlign: "center", borderBottom: `1px solid ${C.border}`, background: "#FAFAF8" }}>
          <div style={{ width: 56, height: 56, borderRadius: "50%", background: C.blueTint, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 12px", fontSize: 20, fontWeight: 700, color: C.blue }}>{initials}</div>
          {loading ? (
            <>
            ...
            <>
              ...
              <p style={{ fontSize: 12, color: C.textSec, margin: "0 0 10px" }}>{phone}</p>
            </>
          )}
        ...
        <button style={{ width: "100%", display: "flex", alignItems: "center", gap: 10, padding: "13px 20px", background: "none", border: "none", cursor: "pointer" }}>
